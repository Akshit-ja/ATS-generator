...
class TestResumeMatcher(unittest.TestCase):
    ...
    def setUp(self, mock_job_analyzer, mock_redis):
        # Mock Redis client
    ...
    def test_calculate_keyword_coverage(self):
        ...
        self.assertEqual(
            len(missing),
            len(self.sample_job_analysis["skills"] +
    ...
    def test_calculate_semantic_similarity(self):
        ...
        similarity = self.resume_matcher._calculate_semantic_similarity("", self.sample_job_description)
    ...
    @patch('app.services.resume_matcher.ResumeMatcher._get_from_cache')
    @patch('app.services.resume_matcher.ResumeMatcher._save_to_cache')
